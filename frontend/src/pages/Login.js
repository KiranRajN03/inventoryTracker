      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-[#F4F4F6]">
        <div className="max-w-md w-full">
          <div className="bg-white border border-[#E5E5E5] p-8">
            <div className="mb-8">
              <h1 className="text-3xl font-black tracking-tighter mb-2" style={{fontFamily: 'Cabinet Grotesk, sans-serif'}}>Inventory Control</h1>
              <p className="text-sm text-[#737373]">Sign in to access your warehouse</p>
            </div>

            {error && (
              <div className="mb-6 p-3 bg-[#FF3B30] text-white text-sm border border-[#E5E5E5]" data-testid="login-error-message">
                {error}
              </div>
            )}
            ...
            <div className="mt-6 text-center">
              <Link to="/register" className="text-sm text-[#002FA7] hover:underline" data-testid="register-link">
